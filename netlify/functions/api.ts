...
// Public aggregated hotspot data (no PII, no auth required)
app.get(["/api/hotspot-data", "/hotspot-data"], async (_req, res) => {
  ...
  res.json({ feedback: feedbackRes.data ?? [], incidents: incidentsRes.data ?? [] });
});
